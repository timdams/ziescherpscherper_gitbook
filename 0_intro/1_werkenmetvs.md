...
![Je kan dit nadien ook altijd nog aanpassen. En zelfs personaliseren tot de vreemdste kleur- en lettertypecombinaties.](../assets/0_intro/vstheme.png)
{% endhint %}
...
![Kies voor C#, niet Visual Basic (VB). Dank bij voorbaat!](../assets/0_intro/opgeletc.png)
